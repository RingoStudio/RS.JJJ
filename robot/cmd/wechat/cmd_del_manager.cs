...
namespace RS.Snail.JJJ.robot.cmd.wechat
{
    ...
    internal class cmd_del_manager : ICMD
    {
        public Context _context { get; set; }
        public cmd_del_manager(Context context)
        {
            _context = context;
        }
        public List<string> Commands => new List<string> { "取消经理", "移除经理", "解绑经理" };
        public List<string> CommandsJP { get => Commands.Select(a => Pinyin.GetInitials(a).ToLower()).ToList(); }
        public List<string> CommandsQP { get => Commands.Select(a => Pinyin.GetPinyin(a).ToLower()).ToList(); }
        public string Tag => "cmd_del_manager";
