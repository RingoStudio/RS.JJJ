...
{
    [attribute.CmdClass]
    internal class cmd_broadcast
    {
        public const string Instrus = "广播";
        public const string Tag = "cmd_broadcast";
        ...
        public static void Do(Context context, Message msg)
        {
            try
            {
                ...
                context.WechatM.SendAtText("请发送\"确定\"立即向绑定俱乐部的群发出以上广播内容。\n" +
                                           "若想要添加文本/文件/图片，请在此发送。\n" +
        ...
        private static void SendBroadCasts(Context context, Message msg, List<string> texts, List<string> images, List<string> files)
        {
            try
            {
                ...
                foreach (var chatroom in context.ContactsM.GetAllGroupWXID(msg.Self, true))
                {
