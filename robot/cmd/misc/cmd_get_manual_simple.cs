...
{
    [attribute.CmdClass]
    internal class cmd_get_manual_simple
    {
        public const string Instrus = "唧唧叽快速入门";
        public const string Tag = "cmd_get_manual_simple";
        ...
        public static void Do(Context context, Message msg)
        {
            try
            {
                var path = AppDomain.CurrentDomain.BaseDirectory + @"BOT\唧唧叽快速入门.pdf";
