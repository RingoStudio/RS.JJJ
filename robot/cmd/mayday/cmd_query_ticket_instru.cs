...
namespace RS.Snail.JJJ.robot.cmd.mayday
{
    ...
    internal class cmd_query_ticket_instru : ICMD
    {
        public Context _context { get; set; }
        public cmd_query_ticket_instru(Context context)
        {
            _context = context;
        }
        public List<string> Commands => new List<string> { "门票字段说明", "门票生成说明", "门票生成文本" };
        public List<string> CommandsJP { get => Commands.Select(a => Pinyin.GetInitials(a).ToLower()).ToList(); }
        public List<string> CommandsQP { get => Commands.Select(a => Pinyin.GetPinyin(a).ToLower()).ToList(); }
        public string Tag => "cmd_query_ticket_instru";
        ...
        public void Do(Message msg)
        {
            try
            {
                ...
                var content = _context.MaydayM.QueryTicketInstru();
                ...
                {
                    var fileName = $"OUT\\门票生成说明_@{_context.ContactsM.QueryGroupMemberNick(msg.Sender, msg.RoomID)}_{DateTime.Now.ToString("yyyy_MM_dd_HH_mm_ss")}.txt";
