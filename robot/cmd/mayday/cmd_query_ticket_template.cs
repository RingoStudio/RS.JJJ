...
namespace RS.Snail.JJJ.robot.cmd.mayday
{
    ...
    internal class cmd_query_ticket_template : ICMD
    {
        public Context _context { get; set; }
        public cmd_query_ticket_template(Context context)
        {
            _context = context;
        }
        public List<string> Commands => new List<string> { "门票文字模板", "门票文字模版" };
        public List<string> CommandsJP { get => Commands.Select(a => Pinyin.GetInitials(a).ToLower()).ToList(); }
        public List<string> CommandsQP { get => Commands.Select(a => Pinyin.GetPinyin(a).ToLower()).ToList(); }
        public string Tag => "cmd_query_ticket_template";
        ...
        public void Do(Message msg)
        {
            try
            {
                ...
                var content = _context.MaydayM.QueryTicketTemplate();
                ...
                {
                    var fileName = $"OUT\\门票文字模板_@{_context.ContactsM.QueryGroupMemberNick(msg.Sender, msg.RoomID)}_{DateTime.Now.ToString("yyyy_MM_dd_HH_mm_ss")}.txt";
