...
namespace RS.Snail.JJJ.robot.cmd.mayday
{
    ...
    internal class cmd_query_recipe_template : ICMD
    {
        public Context _context { get; set; }
        public cmd_query_recipe_template(Context context)
        {
            _context = context;
        }
        public List<string> Commands => new List<string> { "处方文字模版", "处方文字模板" };
        public List<string> CommandsJP { get => Commands.Select(a => Pinyin.GetInitials(a).ToLower()).ToList(); }
        public List<string> CommandsQP { get => Commands.Select(a => Pinyin.GetPinyin(a).ToLower()).ToList(); }
        public string Tag => "cmd_query_recipe_template";
        ...
        public void Do(Message msg)
        {
            try
            {
                ...
                var content = _context.MaydayM.QueryRecipeTemplate();
                ...
                {
                    var fileName = $"OUT\\处方文字模板_@{_context.ContactsM.QueryGroupMemberNick(msg.Sender, msg.RoomID)}_{DateTime.Now.ToString("yyyy_MM_dd_HH_mm_ss")}.txt";
