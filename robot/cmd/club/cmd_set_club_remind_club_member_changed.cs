...
{
    [attribute.CmdClass]
    internal class cmd_set_club_remind_club_member_changed
    {
        public const string Instrus = "设置提醒俱乐部成员变动,提醒俱乐部成员变动";
        public const string Tag = "cmd_set_club_remind_club_member_changed";
