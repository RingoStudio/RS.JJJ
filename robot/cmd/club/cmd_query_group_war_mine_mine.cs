...
{
    [attribute.CmdClass]
    internal class cmd_query_group_war_mine_mine
    {
        public const string Instrus = "我的矿";
        public const string Tag = "cmd_query_group_war_mine_mine";
        ...
        public static void Do(Context context, Message msg)
        {
            try
            {
                ...
                var result = context.ClubsM.QueryGroupWarMineMine(msg.Self, rid, group, msg.WXID);
