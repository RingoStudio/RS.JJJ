...
{
    [attribute.CmdClass]
    internal class cmd_query_group_war_drill_not_use
    {
        public const string Instrus = "查询钻头未用,查询钻头剩余";
        public const string Tag = "cmd_query_group_war_drill_not_use";
        ...
        public static void Do(Context context, Message msg)
        {
            try
            {
                ...
                var result = context.ClubsM.QueryGroupWarDrillNotUse(msg.Self, rid);
