...
{
    [attribute.CmdClass]
    internal class cmd_query_group_war_mine_others
    {
        public const string Instrus = "看看矿,他的矿,她的矿,ta的矿,你的矿";
        public const string Tag = "cmd_query_group_war_mine_others";
        ...
        public static void Do(Context context, Message msg)
        {
            try
            {
                ...
                var result = context.ClubsM.QueryGroupWarMineMine(msg.Self, rid, group, wxid);
