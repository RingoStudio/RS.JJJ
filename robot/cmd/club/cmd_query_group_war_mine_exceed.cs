...
{
    [attribute.CmdClass]
    internal class cmd_query_group_war_mine_exceed
    {
        public const string Instrus = "查询挖矿超时";
        public const string Tag = "cmd_query_group_war_mine_exceed";
        ...
        public static void Do(Context context, Message msg)
        {
            try
            {
                ...
                var result = context.ClubsM.QueryGroupWarMineExceed(msg.Self, rid);
