...
{
    [attribute.CmdClass]
    internal class cmd_query_group_war_token_silver
    {
        public const string Instrus = "查询银牌,查询银令牌";
        public const string Tag = "cmd_query_group_war_token_silver";
        ...
        public static void Do(Context context, Message msg)
        {
            try
            {
                ...
                var result = context.ClubsM.QueryGroupWarSilverToke(msg.Self, rid);
