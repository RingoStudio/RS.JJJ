...
{
    [attribute.CmdClass]
    internal class cmd_query_group_war_drill_lack
    {
        public const string Instrus = "查询钻头未达标";
        public const string Tag = "cmd_query_group_war_drill_lack";
        ...
        public static void Do(Context context, Message msg)
        {
            try
            {
                ...
                var result = context.ClubsM.QueryGroupWarDrillLack(msg.Self, rid);
