...
{
    [attribute.CmdClass]
    internal class cmd_remind_group_war_token_gold_not_buy
    {
        public const string Instrus = "提醒金牌未氪,提醒金令牌未氪,提醒氪金牌,提醒氪金令牌";
        public const string Tag = "cmd_remind_group_war_token_gold_not_buy";
        ...
        public static void Do(Context context, Message msg)
        {
            try
            {
                ...
                var result = context.ClubsM.RemindGroupWarTokenGoldNotBuy(msg.Self, rid, msg.Sender, msg.WXID);
                if (!result.result)
                {
