...
{
    [attribute.CmdClass]
    internal class cmd_query_group_war_mine_near
    {
        public const string Instrus = "查询挖矿到期,查询挖矿临期";
        public const string Tag = "cmd_query_group_war_mine_near";
        ...
        public static void Do(Context context, Message msg)
        {
            try
            {
                ...
                var result = context.ClubsM.QueryGroupWarMineNear(msg.Self, rid);
