...
{
    [attribute.CmdClass]
    internal class cmd_set_club_remind_group_member_changed
    {
        public const string Instrus = "设置提醒微信群成员变动,提醒微信群成员变动";
        public const string Tag = "cmd_set_club_remind_group_member_changed";
