...
{
    [attribute.CmdClass]
    internal class cmd_query_group_war_mine_image
    {
        public const string Instrus = "生成矿点表,生成矿点图";
        public const string Tag = "cmd_query_group_war_mine_image";
        ...
        public static void Do(Context context, Message msg)
        {
            try
            {
                ...
                var result = context.ClubsM.GetGroupWarEventsMineImage(msg.Self, rid);
