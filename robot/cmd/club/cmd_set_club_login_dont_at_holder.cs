...
{
    [attribute.CmdClass]
    internal class cmd_set_club_login_dont_at_holder
    {
        public const string Instrus = "设置登录提示会长,设置登录at会长";
        public const string Tag = "cmd_set_club_login_dont_at_holder";
