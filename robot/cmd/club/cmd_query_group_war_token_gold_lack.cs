...
{
    [attribute.CmdClass]
    internal class cmd_query_group_war_token_gold_lack
    {
        public const string Instrus = "查询金牌未领,查询金令牌未领";
        public const string Tag = "cmd_query_group_war_token_gold_lack";
        ...
        public static void Do(Context context, Message msg)
        {
            try
            {
                ...
                var result = context.ClubsM.QueryGroupWarGoldTokeLack(msg.Self, rid);
