...
{
    [attribute.CmdClass]
    internal class cmd_query_group_war_incorrect_kit
    {
        public const string Instrus = "查询领错套装";
        public const string Tag = "cmd_query_group_war_incorrect_kit";
        ...
        public static void Do(Context context, Message msg)
        {
            try
            {
                ...
                var result = context.ClubsM.QueryIncorrectKit(msg.Self, rid);
