...
{
    [attribute.CmdClass]
    internal class cmd_query_group_war_token_silver_lack
    {
        public const string Instrus = "查询银牌未领,查询银令牌未领";
        public const string Tag = "cmd_query_group_war_token_silver_lack";
        ...
        public static void Do(Context context, Message msg)
        {
            try
            {
                ...
                var result = context.ClubsM.QueryGroupWarSilverTokeLack(msg.Self, rid);
