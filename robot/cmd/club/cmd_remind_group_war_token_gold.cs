...
{
    [attribute.CmdClass]
    internal class cmd_remind_group_war_token_gold
    {
        public const string Instrus = "提醒金牌,提醒金令牌";
        public const string Tag = "cmd_remind_group_war_token_gold";
        ...
        public static void Do(Context context, Message msg)
        {
            try
            {
                ...
                var result = context.ClubsM.RemindGroupWarTokenGold(msg.Self, rid, msg.Sender, msg.WXID);
                if (!result.result)
                {
