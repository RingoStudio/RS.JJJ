...
{
    [attribute.CmdClass]
    internal class cmd_query_group_war_mine
    {
        public const string Instrus = "查询挖矿";
        public const string Tag = "cmd_query_group_war_mine";
        ...
        public static void Do(Context context, Message msg)
        {
            try
            {
                ...
                var result = context.ClubsM.QueryGroupWarMine(msg.Self, rid, near);
