...
namespace RS.Snail.JJJ.robot.cmd.club
{
    ...
    internal class cmd_query_group_war_mine : ICMD
    {
        public Context _context { get; set; }
        public cmd_query_group_war_mine(Context context)
        {
            _context = context;
        }
        public List<string> Commands => new List<string> { "查询挖矿" };
        public List<string> CommandsJP { get => Commands.Select(a => Pinyin.GetInitials(a).ToLower()).ToList(); }
        public List<string> CommandsQP { get => Commands.Select(a => Pinyin.GetPinyin(a).ToLower()).ToList(); }
        public string Tag => "cmd_query_group_war_mine";
        ...
        async public Task Do(Message msg)
        {
            try
            {
                ...
                near = Math.Min(100, Math.Max(0, near));
                ...
                var result = _context.ClubsM.QueryGroupWarMine(msg.Self, rid, near);
