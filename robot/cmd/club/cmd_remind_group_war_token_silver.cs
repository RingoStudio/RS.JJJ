...
{
    [attribute.CmdClass]
    internal class cmd_remind_group_war_token_silver
    {
        public const string Instrus = "提醒银牌,提醒银令牌";
        public const string Tag = "cmd_remind_group_war_token_silver";
        ...
        public static void Do(Context context, Message msg)
        {
            try
            {
                ...
                var result = context.ClubsM.RemindGroupWarTokenSilver(msg.Self, rid, msg.Sender, msg.WXID);
                if (!result.result)
                {
