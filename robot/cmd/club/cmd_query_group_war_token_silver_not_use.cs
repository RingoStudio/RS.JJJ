...
{
    [attribute.CmdClass]
    internal class cmd_query_group_war_token_silver_not_use
    {
        public const string Instrus = "查询银牌未用,查询银令牌未用,查询银牌剩余,查询银令牌剩余";
        public const string Tag = "cmd_query_group_war_token_silver_not_use";
        ...
        public static void Do(Context context, Message msg)
        {
            try
            {
                ...
                var result = context.ClubsM.QueryGroupWarSilverTokeNotUse(msg.Self, rid);
