...
{
    [attribute.CmdClass]
    internal class cmd_remind_group_war_get_resource
    {
        public const string Instrus = "提醒领资源";
        public const string Tag = "cmd_remind_group_war_get_resource";
        ...
        public static void Do(Context context, Message msg)
        {
            try
            {
                ...
                var result = context.ClubsM.RemindGroupWarGetResources(msg.Self, rid, msg.Sender, msg.WXID);
                if (!result.result)
                {
