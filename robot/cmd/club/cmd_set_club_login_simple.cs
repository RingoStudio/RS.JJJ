...
//    internal class cmd_set_club_login_simple : ICMD
//    {
//        public Context _context { get; set; }
//        public cmd_set_club_login_simple(Context context)
//        {
//            _context = context;
//        }
//        public List<string> Commands => new List<string> { "设置简易登录", "设置事件登录" };
//        public List<string> CommandsJP { get => Commands.Select(a => Pinyin.GetInitials(a).ToLower()).ToList(); }
//        public List<string> CommandsQP { get => Commands.Select(a => Pinyin.GetPinyin(a).ToLower()).ToList(); }
//        public string Tag => "cmd_set_club_login_simple";
...
//                club.LoginSimpleMode = (mode > 0);
//                var desc = $"已将俱乐部[{club.Name}]的简易登录设置为";
//                desc += club.LoginSimpleMode ? "[开启]\n从下一次登录开始，该俱乐部将只抓取物种事件数据\n其他数据将被忽略，以节省登录时间" :
//                                         "[关闭]\n从下一次登录开始，该俱乐部将抓取所有数据";
