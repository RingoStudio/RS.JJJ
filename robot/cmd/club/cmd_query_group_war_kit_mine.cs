...
namespace RS.Snail.JJJ.robot.cmd.club
{
    ...
    internal class cmd_query_group_war_kit_mine : ICMD
    {
        public Context _context { get; set; }
        public cmd_query_group_war_kit_mine(Context context)
        {
            _context = context;
        }
        public List<string> Commands => new List<string> { "查看我的套装", "我的套装" };
        public List<string> CommandsJP { get => Commands.Select(a => Pinyin.GetInitials(a).ToLower()).ToList(); }
        public List<string> CommandsQP { get => Commands.Select(a => Pinyin.GetPinyin(a).ToLower()).ToList(); }
        public string Tag => "cmd_query_group_war_kit_mine";
        ...
        public void Do(Message msg)
        {
            try
            {
                ...
                var result = _context.ClubsM.QueryMyKit(msg.RoomID, msg.Sender);

                if (string.IsNullOrEmpty(result)) result = "⚠️未查询到任何信息。";
