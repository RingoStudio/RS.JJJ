...
{
    [attribute.CmdClass]
    internal class cmd_query_group_war_kit_mine
    {
        public const string Instrus = "查看我的套装,我的套装";
        public const string Tag = "cmd_query_group_war_kit_mine";
        ...
        public static void Do(Context context, Message msg)
        {
            try
            {
                ...
                var result = context.ClubsM.QueryMyKit(msg.Self, msg.Sender, msg.WXID);
