...
{
    [attribute.CmdClass]
    internal class cmd_query_group_war_drill
    {
        public const string Instrus = "查询钻头";
        public const string Tag = "cmd_query_group_war_drill";
        ...
        public static void Do(Context context, Message msg)
        {
            try
            {
                ...
                var result = context.ClubsM.QueryGroupWarDrill(msg.Self, rid);
