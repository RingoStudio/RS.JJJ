...
{
    [attribute.CmdClass]
    internal class cmd_query_group_war_token_gold_buy
    {
        public const string Instrus = "查询金牌已氪,查询金令牌已氪";
        public const string Tag = "cmd_query_group_war_token_gold_buy";
        ...
        public static void Do(Context context, Message msg)
        {
            try
            {
                ...
                var result = context.ClubsM.QueryGroupWarGoldTokeBuy(msg.Self, rid);
