...
{
    [attribute.CmdClass]
    internal class cmd_remind_group_war_history
    {
        public const string Instrus = "提醒物种历史,提醒历史";
        public const string Tag = "cmd_remind_group_war_history";
        ...
        public static void Do(Context context, Message msg)
        {
            try
            {
                ...
                var result = context.ClubsM.RemindGroupWarHistory(msg.Self, rid, msg.Sender, msg.WXID);
                if (!result.result)
                {
