...
{
    [attribute.CmdClass]
    internal class cmd_remind_group_war_token_silver_not_buy
    {
        public const string Instrus = "提醒银牌未氪,提醒银令牌未氪,提醒氪银牌,提醒氪银令牌";
        public const string Tag = "cmd_remind_group_war_token_silver_not_buy";
        ...
        public static void Do(Context context, Message msg)
        {
            try
            {
                ...
                var result = context.ClubsM.RemindGroupWarTokenSilverNotBuy(msg.Self, rid, msg.Sender, msg.WXID);
                if (!result.result)
                {
