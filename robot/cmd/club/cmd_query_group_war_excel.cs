...
{
    [attribute.CmdClass]
    internal class cmd_query_group_war_excel
    {
        public const string Instrus = "查询物种总览";
        public const string Tag = "cmd_query_group_war_excel";
        ...
        public static void Do(Context context, Message msg)
        {
            try
            {
                ...
                var result = context.ClubsM.QueryGroupWarHistoryExcel(msg.Self, rid);
