...
{
    [attribute.CmdClass]
    internal class cmd_remind_group_war_clear_resource
    {
        public const string Instrus = "提醒清资源";
        public const string Tag = "cmd_remind_group_war_clear_resource";
        ...
        public static void Do(Context context, Message msg)
        {
            try
            {
                ...
                var result = context.ClubsM.RemindGroupWarUseResources(msg.Self, rid, msg.Sender, msg.WXID);
                if (!result.result)
                {
