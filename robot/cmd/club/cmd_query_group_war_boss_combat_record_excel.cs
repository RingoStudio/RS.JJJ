...
{
    [attribute.CmdClass]
    internal class cmd_query_group_war_boss_combat_record_excel
    {
        public const string Instrus = "查询boss伤害总览";
        public const string Tag = "cmd_query_group_war_boss_combat_record_excel";
        ...
        public static void Do(Context context, Message msg)
        {
            try
            {
                ...
                var result = context.ClubsM.QueryGroupWarBossCombatRecordExcel(msg.Self, rid);
