...
{
    [attribute.CmdClass]
    internal class cmd_query_group_war_kit_image
    {
        public const string Instrus = "生成布阵图";
        public const string Tag = "cmd_query_group_war_kit_image";
        ...
        public static void Do(Context context, Message msg)
        {
            try
            {
                ...
                var result = context.ClubsM.GetClubKitPlanImage(msg.Self, rid);
