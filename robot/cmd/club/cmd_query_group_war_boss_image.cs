...
{
    [attribute.CmdClass]
    internal class cmd_query_group_war_boss_image
    {
        public const string Instrus = "生成boss表,生成boss图";
        public const string Tag = "cmd_query_group_war_boss_image";
        ...
        public static void Do(Context context, Message msg)
        {
            try
            {
                ...
                var result = context.ClubsM.GetGroupWarEventsBossImage(msg.Self, rid);
