...
{
    [attribute.CmdClass]
    internal class cmd_query_group_war_token_gold_not_buy
    {
        public const string Instrus = "查询金牌未氪,查询金令牌未氪";
        public const string Tag = "cmd_query_group_war_token_gold_not_buy";
        ...
        public static void Do(Context context, Message msg)
        {
            try
            {
                ...
                var result = context.ClubsM.QueryGroupWarGoldTokeNotBuy(msg.Self, rid);
