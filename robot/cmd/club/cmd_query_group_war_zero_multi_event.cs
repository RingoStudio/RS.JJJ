...
{
    [attribute.CmdClass]
    internal class cmd_query_group_war_zero_multi_event
    {
        public const string Instrus = "查询未参与事件";
        public const string Tag = "cmd_query_group_war_zero_multi_event";
        ...
        public static void Do(Context context, Message msg)
        {
            try
            {
                ...
                var result = context.ClubsM.QueryGroupWarZeroMultiEvent(msg.Self, rid);
