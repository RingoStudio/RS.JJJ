...
{
    [attribute.CmdClass]
    internal class cmd_query_group_war_history
    {
        public const string Instrus = "查询物种历史";
        public const string Tag = "cmd_query_group_war_history";
        ...
        public static void Do(Context context, Message msg)
        {
            try
            {
                ...
                var result = context.ClubsM.QueryGroupWarHistoryData(msg.Self, rid);
