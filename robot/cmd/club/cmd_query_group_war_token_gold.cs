...
{
    [attribute.CmdClass]
    internal class cmd_query_group_war_token_gold
    {
        public const string Instrus = "查询金牌,查询金令牌";
        public const string Tag = "cmd_query_group_war_token_gold";
        ...
        public static void Do(Context context, Message msg)
        {
            try
            {
                ...
                var result = context.ClubsM.QueryGroupWarGoldToke(msg.Self, rid);
