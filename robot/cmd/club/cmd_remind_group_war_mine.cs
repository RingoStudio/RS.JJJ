...
{
    [attribute.CmdClass]
    internal class cmd_remind_group_war_mine
    {
        public const string Instrus = "提醒挖矿";
        public const string Tag = "cmd_remind_group_war_mine";
        ...
        public static void Do(Context context, Message msg)
        {
            try
            {
                ...
                var result = context.ClubsM.RemindGroupWarMine(msg.Self, rid, msg.Sender, msg.WXID, near);
                if (!result.result)
                {
