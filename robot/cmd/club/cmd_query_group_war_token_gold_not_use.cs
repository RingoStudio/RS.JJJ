...
{
    [attribute.CmdClass]
    internal class cmd_query_group_war_token_gold_not_use
    {
        public const string Instrus = "查询金牌未用,查询金令牌未用,查询金牌剩余,查询金令牌剩余";
        public const string Tag = "cmd_query_group_war_token_gold_not_use";
        ...
        public static void Do(Context context, Message msg)
        {
            try
            {
                ...
                var result = context.ClubsM.QueryGroupWarGoldTokeNotUse(msg.Self, rid);
