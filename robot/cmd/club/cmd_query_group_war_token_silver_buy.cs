...
{
    [attribute.CmdClass]
    internal class cmd_query_group_war_token_silver_buy
    {
        public const string Instrus = "查询银牌已氪,查询银令牌已氪";
        public const string Tag = "cmd_query_group_war_token_silver_buy";
        ...
        public static void Do(Context context, Message msg)
        {
            try
            {
                ...
                var result = context.ClubsM.QueryGroupWarSilverTokeBuy(msg.Self, rid);
